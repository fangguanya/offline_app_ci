...
class MyGame extends BaseGame {
  ...
  MyGame() {
    ...
    // size = Size(MyGameProfile.width(), MyGameProfile.width());
    ...
    var gameBg = SpriteComponent.rectangle(bgWidth * scale, bgHeight * scale, "gamebg.png");
    gameBg
    ...
    var headmount = SpriteComponent.rectangle(64 * 0.5, 64 * 0.5, "headmount.png");
    headmount
      .. anchor = Anchor.center
      .. x = size.width / 2
      .. y = size.height / 2;
...
//      ..y = size.height-50);
  ...
  setGameData(OneGameData gameinfo) {
    if(gameinfo == null) {
      return;
    }
    ...
    final hmdIconScale = 0.5;
    final weaponIconScale = 0.5;

    if(this.gameinfo.clients.length != hmdImages.length) {
      ...
      this.gameinfo.clients.forEach((k, v) {
        ...
        hmdImages[k] = SpriteComponent.rectangle(64 * hmdIconScale, 64 * hmdIconScale, "headmount.png");
